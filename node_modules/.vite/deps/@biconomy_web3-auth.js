import {
  require_client
} from "./chunk-6CUTRGOE.js";
import {
  WalletConnectProvider,
  init_ethereumProvider_esm
} from "./chunk-I2WE7VKO.js";
import {
  ADAPTER_CATEGORY,
  ADAPTER_EVENTS,
  ADAPTER_NAMESPACES,
...
} from "./chunk-B3HWVZES.js";
import {
  require_crypto
} from "./chunk-4V33XHYS.js";
import {
  require_react
} from "./chunk-OO2G4PSF.js";
import {
  require_src
...
// node_modules/@toruslabs/openlogin/node_modules/@toruslabs/eccrypto/browser.js
var require_browser = __commonJS({
  "node_modules/@toruslabs/openlogin/node_modules/@toruslabs/eccrypto/browser.js"(exports) {
    "use strict";
    init_process();
    init_buffer();
...
var import_loglevel, import_regenerator2, import_eccrypto, import_lodash, import_pump, modalDOMElementID, storeKey, UX_MODE, OPENLOGIN_METHOD, ALLOWED_INTERACTIONS, OPENLOGIN_NETWORK, SUPPORTED_KEY_CURVES, log2, htmlToElement, sessionStorageAvailable, localStorageAvailable, handleStream, Modal, MemoryStore, OpenLoginStore, Provider, OpenLogin;
var init_openlogin_esm = __esm({
  "node_modules/@toruslabs/openlogin/dist/openlogin.esm.js"() {
    ...
    log2 = import_loglevel.default.getLogger("openlogin");
                ...
                switch (_context2.prev = _context2.next) {
                  ...
                  case 2:
                    ...
                    if (documentIFrameElem) {
                      ...
                      log2.info("already initialized, removing previous modal iframe");
                    }
      ...
      _createClass(Provider2, [{
        ...
        value: function setupStream() {
          ...
          (0, import_pump.default)(JRPCConnection.stream, this.mux.createStream("jrpc"), JRPCConnection.stream, function(error) {
            log2.error("JRPC connection broken", error);
          });
    ...
    OpenLogin = function() {
      function OpenLogin2(options) {
        ...
        this.initState(_objectSpread3(_objectSpread3({}, options), {}, {
      ...
      _createClass(OpenLogin2, [{
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  ...
                  case 4:
                    ...
                    this._syncState({
                      originData: _objectSpread3(_objectSpread3({}, whitelist), filteredOriginData),
                      whiteLabel: _objectSpread3(_objectSpread3({}, whiteLabel), this.state.whiteLabel)
                    });
                  case 9:
                  case "end":
                    return _context2.stop();
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  case 0:
                    ...
                    loginParams = _objectSpread3(_objectSpread3({
              ...
              while (1) {
                switch (_context8.prev = _context8.next) {
                  ...
                  case 18:
                    ...
                    params = [_objectSpread3(_objectSpread3({}, session), params[0])];
        ...
        value: function _syncState(newState) {
          ...
          this.state = _objectSpread3(_objectSpread3(_objectSpread3({}, this.state), newState), {}, {
            store
          });
        }
      }, {
...
var import_regenerator3, import_lodash2, getOpenloginDefaultOptions, OpenloginAdapter;
  ...
  "node_modules/@web3auth/openlogin-adapter/dist/openloginAdapter.esm.js"() {
    ...
    OpenloginAdapter = function(_BaseAdapter) {
      ...
      function OpenloginAdapter2(params) {
        ...
        _this.openloginOptions = _objectSpread4(_objectSpread4({
          clientId: "",
          network: OPENLOGIN_NETWORK.MAINNET
        ...
        _this.loginSettings = _objectSpread4(_objectSpread4({}, defaultOptions.loginSettings), params.loginSettings);
        ...
        if ((_params$chainConfig3 = params.chainConfig) !== null && _params$chainConfig3 !== void 0 && _params$chainConfig3.chainNamespace) {
          ...
          _this.chainConfig = _objectSpread4(_objectSpread4({}, defaultChainIdConfig), params === null || params === void 0 ? void 0 : params.chainConfig);
      ...
      _createClass(OpenloginAdapter2, [{
        ...
        get: function get2() {
          return this.chainConfig ? _objectSpread4({}, this.chainConfig) : null;
        }
      }, {
        key: "provider",
        get: function get2() {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 5:
                    ...
                    this.openloginOptions = _objectSpread4(_objectSpread4({}, this.openloginOptions), {}, {
              ...
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    this.emit(ADAPTER_EVENTS.CONNECTING, _objectSpread4(_objectSpread4({}, params), {}, {
        ...
        value: function setAdapterSettings(adapterSettings) {
          ...
          this.openloginOptions = _objectSpread4(_objectSpread4(_objectSpread4({}, defaultOptions.adapterSettings), this.openloginOptions || {}), adapterSettings);
          if (adapterSettings.sessionTime) {
            this.loginSettings = _objectSpread4(_objectSpread4({}, this.loginSettings), {}, {
              ...
              while (1) {
                switch (_context6.prev = _context6.next) {
                  ...
                  case 5:
                    ...
                    _context6.next = 8;
                    return import("./solanaProvider.esm-I5WDPWKX.js");
                  case 8:
                  ...
                  case 13:
                    ...
                    _context6.next = 16;
                    return import("./ethereumProvider.esm-S6DX3A2K.js");
                  case 16:
                  ...
                  case 26:
                    ...
                    _context6.next = 30;
                    return this.openloginInstance.login((0, import_lodash2.default)(this.loginSettings, params, {
                      loginProvider: params.loginProvider
                    }, {
                      extraLoginOptions: _objectSpread4(_objectSpread4({}, params.extraLoginOptions || {}), {}, {
                  ...
                  case 30:
                    ...
                    _context6.next = 35;
                    return import("./openloginEd25519.esm-PGR32NCG.js");
                  case 35:
  ...
  "node_modules/@web3auth/wallet-connect-v1-adapter/dist/walletConnectV1Adapter.esm.js"() {
    ...
    WalletConnectV1Adapter = function(_BaseEvmAdapter) {
      ...
      function WalletConnectV1Adapter2(options) {
        ...
        _defineProperty(_assertThisInitialized(_this), "rehydrated", false);
        _this.adapterOptions = _objectSpread5({}, options);
